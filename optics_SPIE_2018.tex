...
The maximum size of the spacecraft is limited by the launch vehicle, the Falcon 9, which carries payloads up to 4.6~m in diameter. 
...
focal plane is telecentric to within 0.12\dgr\ across the entire surface.
