...
\authorinfo{\comr{To be added} Further author information: (Send correspondence to A.A.A.)\\A.A.A.: E-mail: aaa@tbk2.edu, Telephone: 1 505 123 1234\\  B.B.A.: E-mail: bba@cmp.com, Telephone: +33 (0)1 98 76 54 32}
...
in 21 bands centered at 21--799~GHz.  Details of these science targets and expected constraints from PICO are in a companion paper, Ref.~\citenum{brian_spie}. 
...
temperatures impact noise levels.  We discuss these major drivers here, other details are given in Ref.~\citenum{brian_spie}.  
...
Mechanical design of the PICO satellite. Components relevant to this paper are labeled, for other details see Ref.~\citenum{brian_spie}. 
...
To arrive at the final design we modify an Open Dragone.  We follow Ref.~\citenum{Granet 2001} to design the initial 
...
% beta, basic, primative, prototype, foundational, foundation
