...
Dragone\cite{planck2000_optics,ACT2011_optics,SPT2008_optics,core2018_inst,LB2016_optics,parshley_ccat_spie}. For PICO we began 
...
%Using $(F\lambda)^2$ is a better comparison than cm$^2$ or deg$^2$ as it takes the different $F$-numbers of the systems into account.
