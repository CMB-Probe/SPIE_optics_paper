...
%\comb{see comment in caption in regard to the temperature of the primary. Check with Paine}.  
...
of view and with astigmatism, or astigmatism \it{and} coma, canceled to first order.\cite{dragone}\cite{dragone_coma}\comr{is that correct? give more references}  
...
We call it `open-Dragone' because of its overall geometry, see Figure~\ref{fig:ray}, and as contrast to the widely 
used `cross-Dragone'. }
...
\comb{is this 'other method' = method2? or is it 1b? \comr{1b}}
...
Comparison of sidelobes for example Crossed (left) and Open (right) Dragones \comb{informal language. How many Corado Dragones are there? do you mean Dragone systems?}  Rays are traced from the center 
