...
%% fixing tense below, above needs chekcing.

%\sout{The PICO telescope is a 1.4~m aperture modified open-Dragone }.  
...
%%% currently here on edits and tense (KARL)
...
reflector shapes, we add Zernike polynomial corrections to the conic surfaces which define the two reflectors.
