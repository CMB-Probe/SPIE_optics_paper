...
multiplexing were explored for PICO, tradeoff details are in Sutin et~al.\cite{brian_spie} \comr{did you 
check that tradeoff details are in fact provided by Sutin et al? }
